  ...
  head: () => ({
    meta: [
      ...
      { title: "PravasX — Travel + Guide, Done Your Way" },
      {
        name: "description",
        content:
          "PravasX brings travel and local guidance together, with pickup, guide-driver support and personalised itineraries.",
      },
      { name: "author", content: "PravasX" },
      { property: "og:title", content: "PravasX — Travel + Guide, Done Your Way" },
      {
