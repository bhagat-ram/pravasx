...
//#region node_modules/.nitro/vite/services/ssr/assets/server-DD_XEmkH.js
var server_DD_XEmkH_exports = /* @__PURE__ */ __exportAll({
	a: () => getRequestHeader,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D5pGgOf6.mjs");
...
var manifest = {
	"5657035a0ee6556f722dba234784a0e3c2460389c82b35f94de2f5440bef5f56": {
		...
		importer: () => import("./admin-auth-BEoINsHP.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BJYadRjh.mjs").then((n) => n.r).then((n) => n.t),
...
//#endregion
export { server_DD_XEmkH_exports as a, getServerFnById as i, createServerFn as n, setResponseHeader as o, getRequestHeader as r, TSS_SERVER_FUNCTION as t };
